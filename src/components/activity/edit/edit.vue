    ...
    <scroll class="wrapper">
      <div>
        <div class="form-wrapper">
          ...
          <div class="form-group">
            <label>姓名</label>
            <input type="text" v-model="activityPersonal.name" placeholder="请输入成员的真实姓名">
          </div>
          <div class="form-group">
            <label>身份证号</label>
            <input type="text" v-model="activityPersonal.code" placeholder="请输入成员的身份证号">
          </div>
        </div>
      ...
      edit() {
        this.axios({
          ...
          data: {
            ...
            name: this.activityPersonal.name,
            code: this.activityPersonal.code
          },
